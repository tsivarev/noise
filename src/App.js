            ...
            <UI.Group title="Звуки">
              <UI.List>
                <UI.ListItem
                  ...
                  <SoundEffectView url={process.env.PUBLIC_URL + '/samples/fire.mp3'} onChange={this.handleChange}
                                   name="fire" value={this.state.fire}/>
                </UI.ListItem>
                <UI.ListItem
                  before={<IconRain size={32}/>}>
                  <SoundEffectView url={process.env.PUBLIC_URL + '/samples/rain.mp3'} onChange={this.handleChange}
                                   name="rain" value={this.state.rain}/>
                </UI.ListItem>
                <UI.ListItem
                  before={<IconWind size={32}/>}>
                  <SoundEffectView url={process.env.PUBLIC_URL + '/samples/wind.mp3'} onChange={this.handleChange}
                ...
                <UI.ListItem
                  ...
                  <SoundEffectView url={process.env.PUBLIC_URL + '/samples/birds.mp3'} onChange={this.handleChange}
                                   name="birds" value={this.state.birds}/>
                </UI.ListItem>
                <UI.ListItem
                  before={<IconWaves size={32}/>}>
                  <SoundEffectView url={process.env.PUBLIC_URL + '/samples/waves.mp3'} onChange={this.handleChange}
            ...
            <UI.Group>
              <UI.List>
                <UI.ListItem multiline>
                  Автор иконок <a href="http://www.freepik.com" title="Freepik">Freepik</a>. Лицензия <a
                  href="http://creativecommons.org/licenses/by/3.0/" title="Creative Commons BY 3.0" target="_blank">CC
                  3.0 BY</a>.
                </UI.ListItem>
                <UI.ListItem multiline>
                  Автор звуков <a href="http://www.freesfx.co.uk/" title="freesfx.co.uk">freesfx.co.uk</a>
                </UI.ListItem>
              </UI.List>
            </UI.Group>
          </UI.Panel>
